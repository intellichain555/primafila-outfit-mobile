...
public class Settings {
    public static final String HOST = "outfit.primafila.it.com";//endparsehost
    public static final String HOME_URL = "https://outfit.primafila.it.com";//endparsehomeurl
    ...
    public static final String PLAY_STORE_LINK_ID = "com.app.primafilaoutfit"; // package name
